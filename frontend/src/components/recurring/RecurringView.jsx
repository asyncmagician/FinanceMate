...
export default function RecurringView() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-obsidian-text">Dépenses Récurrentes</h1>
        <p className="text-obsidian-text-muted mt-2">
          Gérez vos dépenses fixes mensuelles. Ces dépenses peuvent être appliquées automatiquement à chaque mois.
        </p>
      </div>

      <div className="card mb-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-xl font-semibold text-obsidian-text">Templates de dépenses</h2>
          <button
            onClick={() => setShowAddForm(!showAddForm)}
            className="btn-primary"
          >
            {showAddForm ? 'Annuler' : 'Ajouter une dépense récurrente'}
          </button>
        </div>
              ...
              >
                <div className="flex-1">
                  ...
                  <div className="text-sm text-obsidian-text-muted">
                    ...
                    Jour {expense.day_of_month} du mois
                  </div>
                </div>
      ...
      <div className="card">
        <h3 className="text-lg font-semibold text-obsidian-text mb-3">
          Comment utiliser les dépenses récurrentes ?
        </h3>
        <ol className="space-y-2 text-obsidian-text-muted">
          <li>1. Ajoutez vos dépenses fixes mensuelles (loyer, abonnements, etc.)</li>
          <li>2. Naviguez vers un mois spécifique</li>
          <li>3. Cliquez sur "Dépenses récurrentes" puis "Appliquer au mois actuel"</li>
          <li>4. Les dépenses seront ajoutées automatiquement (sans doublon)</li>
        </ol>
      </div>
